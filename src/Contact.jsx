...
[name]:value,
    ...
    const formSubmit=(e)=>{
e.preventDefault();
alert(`My name is ${data.fullname}. My mobile number is ${data.phone}. My email is ${data.email}. My country is ${data.country}. Here i want to say ${data.msg}`)
    }
    return (
        <>
          <div className="my-5">
...
<div className="col-md-6 col-10 mx-auto">
    <form onSubmit={formSubmit}><div className="mb-3">
...
<div className="mb-3">
  ...
  <input type="text" className="form-control" id="exampleFormControlInput1" name="country" value={data.country} onChange={inputEvent} placeholder="Enter your country" required/>
</div>
<div className="mb-3">
